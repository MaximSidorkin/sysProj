...
class ASeleniumLogin_1(unittest.TestCase):
    ...
    def test_007_NewPjctFormBlock(self):
        ...
        autorName = driver.find_element_by_xpath("html/body/span/span/span[1]/input").send_keys("ipad" + Keys.ENTER)
        # куратор
        pjctMansger = driver.find_element_by_xpath("//div[@id='DIV_PROJECT_CURATOR']/div/span/span/span/span[2]").click()
        pjctMansgerName = driver.find_element_by_xpath("html/body/span/span/span[1]/input").send_keys("ipad" + Keys.ENTER)
