...
class BSeleniumOpenAllPjct_2(unittest.TestCase):   #del
    def test_OpenAllPjct(self):                 #del
        time.sleep(3)
...
class DSeleniumTestConfirm_4(unittest.TestCase):
    def test_Confirm(self):
        ...
        assert "404" not in driver.title                                           #проверка на 500 ошибку
        #driver.close()
